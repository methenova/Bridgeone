      ...
      <div className="max-w-[1400px] mx-auto px-6 sm:px-10 min-h-screen relative z-10 grid lg:grid-cols-2 gap-12 lg:gap-8 items-center pt-24 lg:pt-0">
        ...
        <div className="hidden lg:flex flex-col text-left space-y-6">
          <div>
            ...
            >
              Sign in to manage your high-conversion live video channels, track performance metrics, and engage with high-intent buyers in real time.
            </motion.p>
          </div>
        ...
        <div className="flex flex-col items-center justify-center p-6 sm:p-12 lg:p-20 relative">
