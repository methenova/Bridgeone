      ...
      <div className="flex gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full rounded-2xl border border-slate-200 bg-slate-50 py-2.5 pl-10 pr-4 text-sm text-slate-900 placeholder-slate-500 outline-none transition-all focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20"
          />
          {localSearch && (
            <button
