...
import { Store, Phone, Mail, MapPin, Loader2, Save } from "lucide-react";
...
export default function SettingsPage() {
  ...
  // Prefill form when shop data is loaded
  useEffect(() => {
    if (shop) {
      reset({
  ...
  return (
    <div className="space-y-6 text-white max-w-4xl">
      ...
      <div>
        ...
        <p className="mt-1 text-slate-400">Configure your storefront details and metadata.</p>
      </div>
