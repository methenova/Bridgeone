  ...
  return (
    <div className="space-y-6 text-white max-w-6xl relative">
      ...
      <div>
        ...
        <p className="mt-1 text-xs text-slate-500">Configure real-time event webhooks, rotate API integration tokens, and view client variables.</p>
      </div>
      ...
      <div className="flex gap-1.5 p-1 bg-slate-900 border border-slate-200/80 rounded-2xl self-start max-w-sm">
        <Button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
            activeTab === "webhooks" ? "bg-blue-600 text-white" : "text-slate-600 hover:text-slate-900 hover:bg-slate-100/50 bg-transparent shadow-none"
          }`}
        >
        ...
        <Button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
            activeTab === "api" ? "bg-blue-600 text-white" : "text-slate-600 hover:text-slate-900 hover:bg-slate-100/50 bg-transparent shadow-none"
          }`}
        >
        ...
        <Button
          ...
          className={`flex items-center gap-1.5 px-4 py-2 rounded-xl text-xs font-bold transition-all cursor-pointer ${
            activeTab === "env" ? "bg-blue-600 text-white" : "text-slate-600 hover:text-slate-900 hover:bg-slate-100/50 bg-transparent shadow-none"
          }`}
        >
        ...
        <div className="grid gap-4 md:gap-6 grid-cols-1 lg:grid-cols-3">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
              <div>
                <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Register Webhook Endpoint</h3>
            ...
            {/* Webhook List */}
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
              <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Active Webhook Subscriptions</h3>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-4">
            <div>
              <h3 className="text-xs font-bold text-slate-500 uppercase tracking-wider">Delivery History</h3>
      ...
      {activeTab === "api" && (
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-6 max-w-4xl">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider text-[10px] text-slate-500">Developer Platform Keys</h3>
      ...
      {activeTab === "env" && (
        <div className="rounded-2xl border border-slate-200 bg-white shadow-sm p-6 space-y-6 max-w-3xl">
          <div>
            <h3 className="text-sm font-bold text-slate-900 uppercase tracking-wider text-[10px] text-slate-500">Environment Information</h3>
